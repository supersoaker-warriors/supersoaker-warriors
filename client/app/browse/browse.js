...
.controller('BrowseController', function ($http, UserService) {
  // Your code here
  // this.header = 'signin';

})
.directive('miniView', ['$document', function($document) {
  return 'hi';
}
]);
...
//     var color = scope.browse.settings;
//     var pixelSize = 16;
